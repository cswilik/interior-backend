...
#last 11 parks 
api_resp2 = RestClient.get("https://developer.nps.gov/api/v1/parks?parkCode=noca,olym,neri,shen,thro,voya,whsa,wica,yell&limit=50&start=0&api_key=#{api_key}")
...
User.create(email:"test@test.com", name:'Chelsey', password: '123', bio:'testing', fav_park:'test park')
User.create(email:"jim@jim.com", name:'Jimmy', password:"1234", bio:"this is Jimmy's profile", fav_park:'HOPE THIS WORKS')
